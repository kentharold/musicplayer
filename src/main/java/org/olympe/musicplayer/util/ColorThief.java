...
public class ColorThief
{
     ...
     *
     * @param sourceImage the source image
     * @param quality     0 is the highest quality settings. 10 is the default. There is a trade-off between quality and
     *                    speed. The bigger the number, the faster a color will be returned but the greater the
     ...
     * @param colorCount  the size of the palette; the number of colors returned
     * @param quality     0 is the highest quality settings. 10 is the default. There is a trade-off between quality and
     *                    speed. The bigger the number, the faster the palette generation but the greater the likelihood
     *                    that colors will be missed.
     * @param ignoreWhite if <code>true</code>, white pixels are ignored
     *
     * @return the palette as array of RGB arrays
     */
    ...
    /**
     * Gets the image's pixels via BufferedImage.getRaster().getDataBuffer(). Fast, but doesn't work for all color
     * models.
     *
     * @param sourceImage the source image
     * @param quality     0 is the highest quality settings. 10 is the default. There is a trade-off between quality and
    ...
    /**
     * Gets the image's pixels via BufferedImage.getRGB(..). Slow, but the fast method doesn't work for all color
     * models.
     *
     * @param sourceImage the source image
     * @param quality     0 is the highest quality settings. 10 is the default. There is a trade-off between quality and
